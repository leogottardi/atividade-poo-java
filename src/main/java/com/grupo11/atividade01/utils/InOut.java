...
public class InOut
{
     ...
     */
    public static void MsgDeErro(String cabecalho, String frase, String nomeJanela)
    {
     ...
     * @param frase     que aparecera dentro da caixa de mensagem
     */
    public static void MsgDeInformacao(String cabecalho, String frase, String nomeJanela)
    {
     ...
     * @param frase     que aparecera dentro da caixa de mensagem
     */
    public static void MsgSemIcone(String cabecalho, String frase, String nomeJanela)
    {
        JOptionPane.showMessageDialog(null, frase, cabecalho,
     ...
     * @param frase     que aparecera dentro da caixa de mensagem
     */
    public static void MsgDeAviso(String cabecalho, String frase, String nomeJanela)
    {
        JOptionPane.showMessageDialog(null, frase, cabecalho,
